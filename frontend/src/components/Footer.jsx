      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-rose-300 leading-relaxed">
            Professional makeup artist based in Uttarakhand. Bridal, party &amp; editorial looks.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-rose-300">
            ...
            <li>
              <a href="https://wa.me/910000000000" className="hover:text-white transition-colors">
                💬 WhatsApp
              </a>
            </li>
            <li>
              <a href="https://www.instagram.com/sonakshimakeupartist/" className="hover:text-white transition-colors">
